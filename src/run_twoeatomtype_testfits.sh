...
# This script can be used to generate and verify parameters for a multi-element type system

g++ -g test_chemfit.cpp -o test_chemfit
g++ -g test_chemfit-energy_evaluator.cpp -o test_chemfit-energy_evaluator

for i in  test-Ar_He_Ar+He # test-Ar+He_50F
do
    for j in 12 # # 6 # 4 5 # 3 6 9 12 -- tok 15 min
    do
        for k in 3 # 1 2 3 4
        do
            # Do the fit
        
            ./test_chemfit ${i}.xyzf 150 $k $j > test_chemfit-cpp.log
            ...
            ./test_chemfit-energy_evaluator ${i}.xyzf 150 $k $j params.txt > result.dat
